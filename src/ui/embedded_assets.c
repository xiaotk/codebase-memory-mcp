...
extern const unsigned char _binary_assets_index_BX_2lBVC_js_data[];
extern const unsigned int _binary_assets_index_BX_2lBVC_js_size;
...
cbm_embedded_file_t CBM_EMBEDDED_FILES[] = {
    {"/assets/index-BX-2lBVC.js", _binary_assets_index_BX_2lBVC_js_data, 0, "application/javascript"},
...
static void __attribute__((constructor)) init_embedded_sizes(void) {
    ...
    files[0].size = _binary_assets_index_BX_2lBVC_js_size;
    files[1].size = _binary_assets_index_D27RSPSK_css_size;
